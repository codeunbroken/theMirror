...
'data'?: Array<any>;
  ...
  /**
   * Path part for operation buyACourse
   */
  static readonly BuyACoursePath = '/buy-course';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `buyACourse()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  buyACourse$Response(params?: {
    body?: {
'courseIds': Array<any>;
}
  },
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, LearnersService.BuyACoursePath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `buyACourse$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  buyACourse(params?: {
...
'courseIds': Array<any>;
  ...
  context?: HttpContext
    ...
    return this.buyACourse$Response(params,context).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }
