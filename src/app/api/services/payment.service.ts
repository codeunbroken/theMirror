...
'key'?: string;
  ...
  context?: HttpContext
    ...
    return this.getPaymentTokens$Response(params,context).pipe(
...
'amountWorth'?: number;
  ...
  context?: HttpContext
    ...
    return this.createPaymentToken$Response(params,context).pipe(
      map((r: StrictHttpResponse<PaymentToken>) => r.body as PaymentToken)
    );
  }
...
'amountLeft'?: number;
    ...
    return this.applyPaymentToken$Response(params,context).pipe(
      map((r: StrictHttpResponse<{
'amountLeft'?: number;
}>) => r.body as {
'amountLeft'?: number;
